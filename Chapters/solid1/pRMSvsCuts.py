...
for i in range(3, 8):
	...
	ys0.append(50*g0.ProjectionY("temp", i, nBins).GetRMS())
	ys1.append(50*g1.ProjectionY("temp", i, nBins).GetRMS())
	ys2.append(50*g2.ProjectionY("temp", i, nBins).GetRMS())
	ys3.append(50*g3.ProjectionY("temp", i, nBins).GetRMS())
